#ifndef PLANTSVSPLANTS_STATUS_BAR_H
#define PLANTSVSPLANTS_STATUS_BAR_H
...
public:
    ...
    void on_draw() {
        ...
        float hp_bar_width = (float)width * max(0, hp) / 100.0f;
        float mp_bar_width = (float)width * min(100, mp) / 100.0f;
...
#endif //PLANTSVSPLANTS_STATUS_BAR_H
